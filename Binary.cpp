...
void BinaryDemos( Mat& pcb_image, Mat& stationery_image )
{
	...
	createTrackbar("Threshold","Binary",nullptr,max_threshold,onBinaryThresholdSlider);
	...
	threshold(gray_stationery_image,otsu_binary_image,current_threshold,max_threshold, THRESH_BINARY | THRESH_OTSU);
