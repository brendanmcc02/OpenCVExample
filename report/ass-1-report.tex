...
\begin{document}
	...
	% talk about rectangularity and how its low, in future could do a perspective transformation and then calculate rectangularity that way, would mean I could have a stricter threshold that would result in less edge cases. 27 is a good example of triangle registering as crosswalk
	
	% color distance - bus lane for example
	
	% heavy reliance on 'magic numbers' and thresholds, could be a case of overfitting
	
	% could talk about night and include night test image
\end{document}