...
\begin{document}
	...
	% successes worth talking about:
	% 16: diagonal + small
	% 18: sloped + damaged crosswalk
	% 21: close call (IoU 50%)
	% 28: road markings (better to do this than 20 as its test)
	% 27: varying shapes (triangular one)
	
	% failures:
	% 22: not predicted at all
	...
	\begin{figure}[H]
		...
		\caption{\newline Image 1: We can observe that even if all individual crossings are not captured, the bounding box gets extended to capture the entire crossing.\newline Image 2: Despite some worn-down and sloped crossings, all are identified.\newline Image 3: \newline Image 4:\newline Image 5: Road markings are not identified as crossings because they exceed my $30$\textdegree $\;$horizontal angle threshold.
		}
	\end{figure}
